...
悬浮内容通常为一个页面的常用功能，但与内容无关的悬浮内容用户通常不感兴趣。因为悬浮内容的特性，用户几乎无法彻底关闭，会降低用户体验
...
* 广告样式：
  ...
  * 只能在两个功能板块之间设置广告，禁止在信息流内插入广告 <Badge text="可选" />

::: tip
“广告”字样应与UI搭配，且使用UI定义的 Badge 样式的容器包裹
:::
...
用户非常喜欢完全无广告的应用，因为他们可以让用户花更少的事件做更多的事情。
